<footer class="footer text-muted">{{ config('app.name', 'ValorTracker - Login') }} was created under Riot Games' "Legal Jibber Jabber" policy using assets owned by Riot Games.  Riot Games does not endorse or sponsor this project.</footer>
</div>
</div>
